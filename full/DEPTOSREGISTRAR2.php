		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Departamentos</span> - Registrar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_styling.html" class="breadcrumb-item">Registrar</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">Llene todos los campos antes de guardar.</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">ID Departamento</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre Departamento</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Numero de contacto</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Correo de contacto</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
						...
						<!--
		                    <fieldset>
		                    	<div class="form-group row">
									<label class="col-form-label col-lg-2">Trabajo</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nacimiento</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
		                    	...
		                    	<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Contacto</legend>
