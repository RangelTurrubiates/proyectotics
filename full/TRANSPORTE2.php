			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span>Control de transporte</h4>
						...
						<div class="modal-content">
							...
							<form action="#" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group row">
										<label class="col-form-label col-sm-3">Fecha de pago</label>
										<div class="col-sm-9">
											<input type="text"  class="form-control border-primary border-2">
										</div>
									</div>
									...
									<div class="form-group row">
										<label class="col-form-label col-sm-3">Ruta
											</label>
										<div class="col-sm-9">
											<input type="text"  class="form-control border-primary border-2">
										</div>
									...
									<div class="form-group row">
										<label class="col-form-label col-sm-3">Horario
											</label>
										<div class="col-sm-9">
											<input type="text" class="form-control border-primary border-2">
										</div>
						...
						<div class="modal-content">
							...
							<form action="#" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group row">
										<label class="col-form-label col-sm-3">Fecha pago</label>
										<div class="col-sm-9">
									...
									<div class="form-group row">
										<label class="col-form-label col-sm-3">Ruta</label>
										<div class="col-sm-9">
											<input type="text" placeholder="Libertad" class="form-control">
										</div>
									</div>

									<div class="form-group row">
										<label class="col-form-label col-sm-3">Horario</label>
										<div class="col-sm-9">
											<input type="text" placeholder="Vespertino" class="form-control">
										</div>
									</div>
